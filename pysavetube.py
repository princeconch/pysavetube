...
if isplaylist == False:
    ...
    #download video and audio streams separately for highest quality
    ...
    #change file to desired format (if not mp4)
    if format != "mp4":
    ...
    #make a directory for the playlist files to be put in
